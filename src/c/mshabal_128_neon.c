...
static void simd128_neon_mshabal_compress(mshabal_context* sc, const unsigned char* buf0,
...
void simd128_neon_mshabal_openclose_fast(mshabal_context_fast* sc, void* u1, void* u2, void* dst0, void* dst1, void* dst2, 
                                          void* dst3) {
    union input {
        u32 words[64];
        __m128i data[16];
